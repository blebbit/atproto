...
#crud: {
  ...
  "describe\(Resource)": defs: main: lexicons.#Query & {
  ...
  "list\(Resources)": {
    defs: main: lexicons.#Query & {
      ...
      auth: permission: "list_\(resource)"
  ...
  "create\(Resource)": {
    defs: main: lexicons.#Procedure & {
      ...
      auth: permission: "create_\(resource)"
  ...
  "update\(Resource)": {
    defs: main: lexicons.#Procedure & {
      ...
      auth: permission: "update_\(resource)"
  ...
  "delete\(Resource)": {
    defs: main: lexicons.#Procedure & {
      ...
      auth: permission: "delete_\(resource)"
