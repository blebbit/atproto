...
export async function checkPermission(client: any, objectType: string, permission: string, subjectType: string) {
  ...
  return permissionResponseToAllowed(response?.permissionship);
}

export async function checkBulkPermission(client: any, objectTypes: string[], permission: string, subjectType: string) {
