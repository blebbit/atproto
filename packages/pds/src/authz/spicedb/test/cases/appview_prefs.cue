...
case: appview_prefs: #case & {
  ...
  relns: {
    ...
    access: [
      ...
      ["  nat -> space", [_space, "record_lister",  _nat]],
      ["  app -> space", [_space, "record_creator", _app]],
      ["  app -> space", [_space, "record_lister",  _app]],
      ["  app -> prefs", [_prefs, "record_deleter", _app]],
      ["  app -> prefs", [_prefs, "record_lister",  _app]],
    ]
  }
  ...
  checks: {
    basic: [
      ...
      ["  read record", "true ", [_root, "record_read", _eli]],
      ["  read record", "false", [_root, "record_read", _nat]],
      ["  read record", "false", [_root, "record_read", _app]],
      ...
      ["  read record ", "true ", [_space, "record_read", _eli]],
      ["  read record ", "true ", [_space, "record_read", _nat]],
      ["  read record ", "true ", [_space, "record_read", _app]],
      ...
      ["  read record ", "true ", [_prefs, "record_read", _eli]],
      ["  read record ", "false", [_prefs, "record_read", _nat]],
      ["  read record ", "true ", [_prefs, "record_read", _app]],
    ]
  ...
  subcases: {
    default: [
      ...
      (util.#relationTo.touchMany & { input: relns.access }).output,
