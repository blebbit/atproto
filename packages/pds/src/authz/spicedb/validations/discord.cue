...
discord: #validation & {
  ...
  relations: [
    ...
    [_space, "record_lister", "anon:*"],
    [_space, "record_lister", "acct:*"], // need to caveat for messages only
    [_space, "blob_reader", "anon:*"],
    [_space, "blob_reader", "acct:*"], // need to caveat for messages only
    ...
    [_space,"record_deleter", "\(_bubble)#member"],
    [_space,"blob_lister", "\(_bubble)#member"],
    [_space,"blob_deleter", "\(_bubble)#member"],
  ...
  asserts: {
    at: [
      ...
      [_root, "owners", _jay],
      [_root, "record_read", _jay],

      // permissions on discord space
      [_space, "owners", _jay],
      [_space, "record_read", _jay],
      [_space, "record_read", _paul],
      [_space, "record_read", _bryan],
      [_space, "record_read", _hailey],

      // permissions on discord bubble
      [_bubble, "owners", _jay],
      [_bubble, "record_read", _jay],
      [_bubble, "record_read", _hailey],
    ...
    af: [
      // permissions on root space
      [_root, "record_read", _paul],
      [_root, "record_read", _bryan],
      [_root, "record_read", _hailey],
      ...
      // permissions on discord bubble
      [_bubble, "record_read", "acct:all"],
      [_bubble, "record_read", "acct:bryan"],
    ]
