    ...
    handler: async ({ auth, params }) => {
      ...
      await dualWriteTransaction({
        ...
        actorOps: async (actorTxn: ActorStoreTransactor) => {
          ...
          spaces = await actorTxn.space.listSpaces(reqSpace)
          roles = await actorTxn.space.listRoles(reqSpace)
          groups = await actorTxn.space.listGroups(reqSpace)
          collections = await actorTxn.space.listCollections(reqSpace)
        },
