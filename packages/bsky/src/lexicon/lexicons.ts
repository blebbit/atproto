...
export const schemaDict = {
        ...
        input: {
          ...
          schema: {
            ...
            properties: {
              ...
              parent: {
                type: 'string',
                description: 'The id of the parent group to nest under.',
              },
              record: {
                type: 'unknown',
                description: 'The record itself. Must contain a $type field.',
  ...
  ComAtprotoSpaceDescribeRepo: {
    lexicon: 1,
    id: 'com.atproto.space.describeRepo',
    defs: {
      main: {
        type: 'query',
        description:
...
export const ids = {
  ...
  ComAtprotoSpaceDescribeRepo: 'com.atproto.space.describeRepo',
